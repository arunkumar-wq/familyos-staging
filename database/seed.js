...
const docs = [
  ...
  { owner: mom.id, name: "Mom's Passport", cat: 'identity', status: 'valid', expiry: '2029-02-10', size: '1.0 MB', mime: 'image/png', file: createDocPreview('passport_mom.svg', 'US PASSPORT', 'SURINDER KAUR SINGH', '#1a3a6b'), ai: 1, summary: '{"type":"US Passport","number":"345678901","expiry":"Feb 10, 2029","confidence":0.96,"fields":[{"key":"Passport Number","value":"345678901","confidence":0.96},{"key":"Full Name","value":"SURINDER KAUR SINGH","confidence":0.94}]}' },
  { owner: mom.id, name: 'Medicare Card', cat: 'insurance', status: 'current', expiry: '2030-06-15', size: '0.4 MB', mime: 'image/png', file: createDocPreview('medicare_mom.svg', 'MEDICARE CARD', 'SURINDER KAUR SINGH', '#003366'), ai: 1, summary: '{"type":"Medicare Card","issuer":"CMS","number":"1EG4-TE5-MK72","confidence":0.96,"fields":[{"key":"Medicare No","value":"1EG4-TE5-MK72","confidence":0.94},{"key":"Part A","value":"Jun 15, 2020","confidence":0.92}]}' },
];
